...
class IsportsProxyFeature extends IsportsBaseFeature
{
    ...
    public function init(IsportsContext $ctx, array $options): void
    {
        ...
        $utility->fetcher = function (IsportsContext $ctx2, string $url2, array $fetchdef) use ($inner): array {
