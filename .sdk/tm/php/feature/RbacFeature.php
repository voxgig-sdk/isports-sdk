...
class IsportsRbacFeature extends IsportsBaseFeature
{
    ...
    private function _required(IsportsContext $ctx): ?string
    {
    ...
    private function _reject(IsportsContext $ctx, string $required): void
    {
    ...
    private function _track(IsportsContext $ctx, string $required, bool $allowed): void
    {
        $client = $this->client;
