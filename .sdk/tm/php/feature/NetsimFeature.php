...
class IsportsNetsimFeature extends IsportsBaseFeature
{
    ...
    private function _simulate(IsportsContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
        $opts = $this->options ?? [];
        $this->calls++;
        $call = $this->calls;
    ...
    private function _track(IsportsContext $ctx, array $applied): void
    {
        $client = $this->client;
