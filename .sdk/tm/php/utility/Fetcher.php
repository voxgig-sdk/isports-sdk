...
// Isports SDK utility: fetcher

class IsportsFetcher
{
    ...
    public const DEFAULT_USER_AGENT = 'Mozilla/5.0 (compatible; IsportsSDK/1.0)';
    ...
    public static function call(IsportsContext $ctx, string $fullurl, array $fetchdef): array
    {
