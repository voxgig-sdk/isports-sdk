...
class IsportsGraphql
{
    ...
    // equivalent.
    public static function body(IsportsContext $ctx): mixed
    {
    ...
    public static function errors(IsportsContext $ctx): bool
    {
        $result = $ctx->result;
        $point = $ctx->point;
