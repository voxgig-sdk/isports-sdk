...
class IsportsTestRunner:
    ...
    @staticmethod
    def env_override(m):
        live = IsportsTestRunner.getenv("PROJECTENV_TEST_LIVE")
        override = IsportsTestRunner.getenv("PROJECTENV_TEST_OVERRIDE")
        ...
        explain = IsportsTestRunner.getenv("PROJECTENV_TEST_EXPLAIN")
