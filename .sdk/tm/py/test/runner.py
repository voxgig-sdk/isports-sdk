...
class IsportsTestRunner:
    ...
    @staticmethod
    def env_override(m):
        live = IsportsTestRunner.getenv("PROJECTNAME_TEST_LIVE")
        override = IsportsTestRunner.getenv("PROJECTNAME_TEST_OVERRIDE")
        ...
        explain = IsportsTestRunner.getenv("PROJECTNAME_TEST_EXPLAIN")
