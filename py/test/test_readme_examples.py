# Isports SDK — documentation python-examples COMPLETENESS gate.
#
...
#      SDK (mentions IsportsSDK) OR drives a client/sdk variable the narrative
#      built earlier ("client." / "sdk."). A constructing block is rewritten so
#      both IsportsSDK(...) and IsportsSDK.test(...) become
#      IsportsSDK.test({"entity": {...}}) seeding one mock record (id "test01")
...
_SDK_MODULE = "isports_sdk"
_SDK_CLASS = "IsportsSDK"
