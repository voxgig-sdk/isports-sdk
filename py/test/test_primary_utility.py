...
from isports_sdk.core.spec import IsportsSpec
from isports_sdk.core.result import IsportsResult
from isports_sdk.core.response import IsportsResponse
from isports_sdk.core.operation import IsportsOperation
from isports_sdk.core.error import IsportsError
...
class TestPrimaryUtility:
    ...
    def test_exists(self):
        client = IsportsSDK.test(None, None)
    ...
    def test_feature_init_basic(self):
        init_client = IsportsSDK.test(None, None)
        ...
        class TestInitFeature(IsportsBaseFeature):
            def __init__(self):
                super().__init__()
                self.name = "initfeat"
                self.active = True
    ...
    def test_feature_init_inactive(self):
        ...
        class TestInitFeatureInactive(IsportsBaseFeature):
            def __init__(self):
                super().__init__()
                self.name = "nofeat"
                self.active = False
    ...
    def test_make_result_no_result(self):
        ...
        utility = client._utility
        ctx = _make_test_full_ctx(client, utility)
        ctx.spec = IsportsSpec({"step": "start"})
        ctx.result = None
    ...
    def test_make_spec_basic(self):
        ...
        spec_client = IsportsSDK.test(None, setup_opts)
    ...
    def test_prepare_auth_basic(self):
        ...
        auth_client = IsportsSDK.test(None, setup_opts)
