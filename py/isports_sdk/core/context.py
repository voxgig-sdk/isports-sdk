...
from isports_sdk.core.control import IsportsControl
...
from isports_sdk.core.helpers import get_ctx_prop, to_map
...
class IsportsContext:
    def __init__(self, ctxmap=None, basectx=None):
        ...
        if isinstance(rp, IsportsResponse):
            self.response = rp
        elif basectx is not None:
    ...
    def make_error(self, code, msg):
        return IsportsError(code, msg, self)
