...
func registerSDKWords(r *eng.Registry, client *sdk.IsportsSDK) {
...
func runOp(client *sdk.IsportsSDK, op string, query *eng.Value, entityAtom eng.Value) ([]eng.Value, error) {
