...
describe("FootballDirect", function()
  it("should direct-load-football", function()
    local setup = football_direct_setup({ id = "direct01" })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-load-football", setup.live and "live" or "unit")
...
function football_direct_setup(mockres)
