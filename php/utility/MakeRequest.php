...
// Isports SDK utility: make_request

require_once __DIR__ . '/../core/Response.php';
require_once __DIR__ . '/../core/Result.php';

class IsportsMakeRequest
{
    public static function call(IsportsContext $ctx): array
    {
        ...
        if ($fetch_err) {
            ...
            $response = new IsportsResponse(['err' => $ctx->make_error('request_no_response', 'response: undefined')]);
        } elseif (is_array($fetched)) {
            $response = new IsportsResponse($fetched);
        } else {
