...
class IsportsRatelimitFeature extends IsportsBaseFeature
{
    ...
    private function _acquire(IsportsContext $ctx): void
    {
    ...
    private function _track(IsportsContext $_ctx, float $wait_ms): void
    {
        $client = $this->client;
