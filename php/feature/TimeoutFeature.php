...
class IsportsTimeoutFeature extends IsportsBaseFeature
{
    ...
    private function _with_timeout(IsportsContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
    ...
    private function _track(IsportsContext $_ctx, float $ms): void
    {
        $client = $this->client;
