...
class IsportsStreamingFeature extends IsportsBaseFeature
{
    ...
    private function _iterate(IsportsResult $result): \Generator
    {
    ...
    private function _streamable(IsportsContext $ctx): bool
    {
