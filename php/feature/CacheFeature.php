...
class IsportsCacheFeature extends IsportsBaseFeature
{
    ...
    private function _through(IsportsContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
