...
// Isports SDK test feature

require_once __DIR__ . '/BaseFeature.php';
require_once __DIR__ . '/../utility/Param.php';

class IsportsTestFeature extends IsportsBaseFeature
{
    ...
    public function init(IsportsContext $ctx, array $options): void
    {
        ...
        $test_fetcher = function (IsportsContext $fctx, string $_fullurl, array $_fetchdef) use ($entity): array {
    ...
    public function makeNetsim(array $net, callable $inner): callable
    {
        ...
        return function (IsportsContext $fctx, string $url, array $fetchdef) use ($net, $inner, $pick_latency, $sleep): array {
            $this->_netcalls++;
            $call = $this->_netcalls;
     ...
     */
    public function buildArgs(IsportsContext $ctx, $op, $args): array
    {
