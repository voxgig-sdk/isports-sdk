...
// Isports SDK — documentation example COMPLETENESS GATE.
//
...
//      EXECUTED offline in seeded test mode (IsportsSDK::test)
...
{
    private const SDK_CLASS = 'IsportsSDK';
    ...
    private const SDK_BASE = 'isports_sdk';
