...
class IsportsTestRunner
{
    ...
    {
        $live = self::getenv('ISPORTS_TEST_LIVE');
        $override = self::getenv('ISPORTS_TEST_OVERRIDE');
        ...
        $explain = self::getenv('ISPORTS_TEST_EXPLAIN');
...
class_alias('IsportsTestRunner', 'Runner');
class_alias('IsportsHelpers', 'Helpers');
