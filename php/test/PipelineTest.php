...
{
    private static function utility(): IsportsUtility
    {
        return new IsportsUtility();
    }
    ...
    private static function ctx(array $over = []): IsportsContext
    {
        $utility = $over['utility'] ?? self::utility();
        $client = $over['client'] ?? new PlClient(['base' => 'http://h']);
        $ctx = new IsportsContext([
            'client' => $client,
            'utility' => $utility,
        ], null);
        $ctx->op = new IsportsOperation(['name' => 'load', 'entity' => 'x']);
        foreach ($over as $k => $v) {
    ...
    {
        return ($err instanceof IsportsError) ? $err->sdk_code : '';
    }
    ...
    public function test_make_point_rejects_a_disallowed_operation(): void
    {
        ...
        $ctx->op = new IsportsOperation(['name' => 'nope', 'entity' => 'x']);
        [$point, $err] = IsportsMakePoint::call($ctx);
    ...
    public function test_make_point_rejects_an_operation_with_no_endpoints(): void
    {
        ...
        $ctx->op = new IsportsOperation(['name' => 'load', 'entity' => 'x', 'points' => []]);
        [$point, $err] = IsportsMakePoint::call($ctx);
        $this->assertNull($point);
    ...
    public function test_make_point_returns_the_single_point(): void
    {
        ...
        $ctx = self::ctx(['options' => ['allow' => ['op' => 'load,list,create,update,remove']]]);
        $ctx->op = new IsportsOperation(['name' => 'load', 'entity' => 'x', 'points' => [$point]]);
        [$got, $err] = IsportsMakePoint::call($ctx);
        $this->assertNull($err);
    ...
    {
        $preset = new IsportsSpec(['method' => 'GET']);
        $ctx = self::ctx();
        $ctx->out['spec'] = $preset;
        [$got, $err] = IsportsMakeSpec::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    public function test_make_response_guards_missing_spec_response_result(): void
    {
        $ctx = self::ctx([
            'spec' => null,
            'response' => new IsportsResponse([]),
            'result' => new IsportsResult([]),
        ]);
        [, $err] = IsportsMakeResponse::call($ctx);
        $this->assertSame('response_no_spec', self::code($err));

        $ctx = self::ctx([
            'spec' => new IsportsSpec([]),
            'response' => null,
            'result' => new IsportsResult([]),
        ]);
        [, $err] = IsportsMakeResponse::call($ctx);
    ...
    {
        $ctx = self::ctx([
            'spec' => new IsportsSpec(['step' => 's']),
            'response' => new IsportsResponse(self::resp(404, null, ['x-a' => '1'])),
            'result' => new IsportsResult([]),
        ]);
        [, $err] = IsportsMakeResponse::call($ctx);
        $this->assertNull($err);
    ...
    public function test_make_response_2xx_parses_the_body_and_marks_ok(): void
    {
        $ctx = self::ctx([
            'spec' => new IsportsSpec(['step' => 's']),
            'response' => new IsportsResponse(self::resp(200, ['v' => 1])),
            'result' => new IsportsResult([]),
        ]);
        [, $err] = IsportsMakeResponse::call($ctx);
        $this->assertNull($err);
    ...
    public function test_make_response_records_to_ctrl_explain_when_explain_is_on(): void
    {
        $ctx = self::ctx([
            'spec' => new IsportsSpec(['step' => 's']),
            'response' => new IsportsResponse(self::resp(200, ['v' => 2])),
            'result' => new IsportsResult([]),
        ]);
        $ctx->ctrl->explain = ['on' => true];
        IsportsMakeResponse::call($ctx);
    ...
    {
        $preset = new IsportsResponse(self::resp(299));
        $ctx = self::ctx([
            'spec' => new IsportsSpec([]),
            'response' => new IsportsResponse([]),
            'result' => new IsportsResult([]),
        ...
        [$got, $err] = IsportsMakeResponse::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    {
        $ctx = self::ctx(['spec' => null, 'result' => new IsportsResult([])]);
        [, $err] = IsportsMakeResult::call($ctx);
        $this->assertSame('result_no_spec', self::code($err));

        $ctx = self::ctx(['spec' => new IsportsSpec([]), 'result' => null]);
        [, $err] = IsportsMakeResult::call($ctx);
    ...
    public function test_make_result_list_op_wraps_resdata_into_entity_instances(): void
    {
        ...
        $ctx = self::ctx([
            'entity' => $entity,
            'spec' => new IsportsSpec(['step' => 's']),
            'result' => new IsportsResult(['ok' => true, 'resdata' => [['a' => 1], ['a' => 2]]]),
        ]);
        $ctx->op = new IsportsOperation(['name' => 'list', 'entity' => 'x']);
        [$result, $err] = IsportsMakeResult::call($ctx);
        $this->assertNull($err);
    ...
    public function test_make_result_empty_list_yields_empty_resdata(): void
    {
        ...
        $ctx = self::ctx([
            'entity' => $entity,
            'spec' => new IsportsSpec(['step' => 's']),
            'result' => new IsportsResult(['ok' => true, 'resdata' => []]),
        ]);
        $ctx->op = new IsportsOperation(['name' => 'list', 'entity' => 'x']);
        [$result, $err] = IsportsMakeResult::call($ctx);
        $this->assertNull($err);
    ...
    {
        $preset = new IsportsResult(['ok' => true]);
        $ctx = self::ctx([
            'spec' => new IsportsSpec([]),
            'result' => new IsportsResult([]),
        ]);
        $ctx->out['result'] = $preset;
        [$got, $err] = IsportsMakeResult::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    public function test_make_request_guards_a_missing_spec(): void
    {
        ...
        [, $err] = IsportsMakeRequest::call($ctx);
    ...
    {
        $utility = self::utility();
        $boom = new IsportsError('boom', 'boom');
        $utility->fetcher = function (IsportsContext $_c, string $_u, array $_f) use ($boom): array {
            return [null, $boom];
        };
        $ctx = self::ctx([
            'utility' => $utility,
            'spec' => new IsportsSpec(['step' => 's', 'method' => 'GET', 'base' => 'http://h', 'parts' => ['a']]),
        ]);
        [$response, $err] = IsportsMakeRequest::call($ctx);
        $this->assertNull($err);
    ...
    {
        $utility = self::utility();
        $utility->fetcher = function (IsportsContext $_c, string $_u, array $_f): array {
            return [null, null];
        };
        $ctx = self::ctx([
            'utility' => $utility,
    ...
    public function test_make_request_a_normal_transport_response_is_wrapped(): void
    {
        ...
        [$response, $err] = IsportsMakeRequest::call($ctx);
        $this->assertNull($err);
        $this->assertInstanceOf(IsportsResponse::class, $response);
    ...
    {
        $utility = self::utility();
        $utility->make_fetch_def = function (IsportsContext $c): array {
            return [null, $c->make_error('fetchdef_boom', 'boom')];
        };
        $ctx = self::ctx([
            'utility' => $utility,
            'spec' => new IsportsSpec(['step' => 's', 'method' => 'GET']),
        ]);
        [$response, $err] = IsportsMakeRequest::call($ctx);
        $this->assertNull($err);
        $this->assertNotNull($response->err);
    ...
    {
        $preset = new IsportsResponse(self::resp(201));
        $ctx = self::ctx(['spec' => new IsportsSpec([])]);
        $ctx->out['request'] = $preset;
        [$got, $err] = IsportsMakeRequest::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    {
        $ctx = self::ctx(['spec' => null]);
        [, $err] = IsportsMakeFetchDef::call($ctx);
    ...
    public function test_make_fetch_def_serialises_body_and_inits_missing_result(): void
    {
        ...
        [$fetchdef, $err] = IsportsMakeFetchDef::call($ctx);
        $this->assertNull($err);
    ...
    {
        $ctx = self::ctx(['result' => new IsportsResult(['ok' => true, 'resdata' => 42])]);
        $this->assertSame(42, IsportsDone::call($ctx));
    }

    public function test_done_raises_the_error_when_not_ok(): void
    {
        $ctx = self::ctx(['result' => new IsportsResult(['ok' => false])]);
        $this->expectException(IsportsError::class);
        IsportsDone::call($ctx);
    }

    public function test_make_error_returns_resdata_when_ctrl_throw_is_false(): void
    {
        $ctx = self::ctx(['result' => new IsportsResult(['ok' => false, 'resdata' => 'fallback'])]);
        $ctx->ctrl->throw_err = false;
        $this->assertSame('fallback', IsportsMakeError::call($ctx, null));
    }
    ...
    public function test_make_error_records_to_ctrl_explain(): void
    {
        ...
        $ctx->ctrl->throw_err = false;
        $ctx->ctrl->explain = ['on' => true];
        IsportsMakeError::call($ctx, null);
    ...
    public function test_feature_add_appends_in_call_order(): void
    {
        ...
        $a = new IsportsBaseFeature();
        $b = new IsportsBaseFeature();
        IsportsFeatureAdd::call($ctx, $a);
        IsportsFeatureAdd::call($ctx, $b);
        $this->assertSame([$a, $b], $client->features);
    }

    private static function named_feature(string $name): IsportsBaseFeature
    {
        $f = new IsportsBaseFeature();
        $f->name = $name;
        return $f;
    }
    ...
    public function test_feature_add_ordering_before_after_replace(): void
    {
        ...
        IsportsFeatureAdd::call($ctx, $miss);
    ...
    private static function auth_ctx(array $options, ?array $headers): IsportsContext
    {
        $client = new PlClient($options);
        return self::ctx([
            'client' => $client,
            'spec' => $headers === null ? null : new IsportsSpec(['headers' => $headers]),
        ]);
    }
    ...
    public function test_prepare_auth_guards_a_missing_spec(): void
    {
        ...
        [, $err] = IsportsPrepareAuth::call($ctx);
    ...
    {
        $ctx = self::ctx([
            'response' => new IsportsResponse(['headers' => null]),
            'result' => new IsportsResult([]),
        ]);
        IsportsResultHeaders::call($ctx);
