...
module IsportsTestRunner
  ...
  def self.env_override(m)
    live = getenv("ISPORTS_TEST_LIVE")
    override = getenv("ISPORTS_TEST_OVERRIDE")
    ...
    explain = getenv("ISPORTS_TEST_EXPLAIN")
    m["ISPORTS_TEST_EXPLAIN"] = explain if explain && !explain.empty?
...
Runner = IsportsTestRunner
Helpers = IsportsHelpers
Vs = VoxgigStruct
