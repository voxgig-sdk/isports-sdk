...
type FootballEntity struct {
	name    string
	client  *core.IsportsSDK
...
func NewFootballEntity(client *core.IsportsSDK, entopts map[string]any) *FootballEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *FootballEntity) GetName() string { return e.name }
...
func (e *FootballEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *FootballEntity) Deleted() bool {
	return e.deleted
}


func (e *FootballEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewFootballEntity(e.client, opts)
}

func (e *FootballEntity) Data(args ...any) any {
...
func (e *FootballEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an Football; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *FootballEntity) DataTyped(data ...Football) Football {
	if len(data) > 0 {
		return typedFrom[Football](e.Data(asMap(data[0])))
	}
	return typedFrom[Football](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through Football (all fields
// optional at the wire level).
func (e *FootballEntity) MatchTyped(match ...Football) Football {
	if len(match) > 0 {
		return typedFrom[Football](e.Match(asMap(match[0])))
	}
	return typedFrom[Football](e.Match())
}
...
func (e *FootballEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *FootballEntity) Load(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// FootballLoadMatch and returns an Football. It delegates to the untyped
// Load (identical runtime) and converts at the typed boundary.
func (e *FootballEntity) LoadTyped(reqmatch FootballLoadMatch, ctrl map[string]any) (Football, error) {
	res, err := e.Load(asMap(reqmatch), ctrl)
	if err != nil {
		return Football{}, err
	}
	return typedFrom[Football](res), nil
}



func (e *FootballEntity) List(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("list", e.name)
}


func (e *FootballEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *FootballEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *FootballEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *FootballEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
