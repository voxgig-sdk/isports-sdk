...
type Args struct {
	Entity string         `json:"entity" jsonschema:"football"`
	Query  map[string]any `json:"query,omitempty" jsonschema:"optional match map e.g. {\"id\":1} for load, omit for list"`
}

func registerTools(server *mcp.Server, client *sdk.IsportsSDK) {
	mcp.AddTool(server, &mcp.Tool{
		Name: "isports_list",
		Description: "List records from Isports. " +
	...
	mcp.AddTool(server, &mcp.Tool{
		Name: "isports_load",
		Description: "Load a single record from Isports. " +
...
func runOp(client *sdk.IsportsSDK, op string, args Args) (*mcp.CallToolResult, any, error) {
...
func entityFor(client *sdk.IsportsSDK, name string) (sdk.IsportsEntity, error) {
	switch strings.ToLower(name) {
	case "football":
		return client.Football(nil), nil
