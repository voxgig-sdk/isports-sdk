...
describe('FootballDirect', async () => {
  ...
  test('direct-load-football', async (t: any) => {
    const setup = directSetup({ id: 'direct01' })
    if (maybeSkipControl(t, 'direct', 'direct-load-football', setup.live)) return
...
function directSetup(mockres?: any) {
  ...
  if (live) {
    ...
    let idmap: any = env['ISPORTS_TEST_FOOTBALL_ENTID']
